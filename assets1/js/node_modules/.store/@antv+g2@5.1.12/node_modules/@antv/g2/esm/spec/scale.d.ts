import { LinearOptions, OrdinalOptions, IdentityOptions, BandOptions, PointOptions, TimeOptions, LogOptions, PowOptions, ThresholdOptions, QuantileOptions, QuantizeOptions, SqrtOptions, SequentialOptions, ConstantOptions } from '@antv/scale';
import { ScaleComponent } from '../runtime';
import { Palette } from './palette';
export type Scale = LinearScale | OrdinalScale | IdentityScale | BandScale | PointScale | TimeScale | LogScale | PowScale | SqrtScale | ThresholdScale | QuantizeScale | QuantileScale | SequentialScale | CustomScale | ConstantScale;
export type ScaleTypes = 'linear' | 'ordinal' | 'identity' | 'band' | 'point' | 'time' | 'log' | 'pow' | 'sqrt' | 'threshold' | 'quantize' | 'quantile' | 'sequential' | 'constant' | ScaleComponent;
...
export type CustomScale = BaseScale<ScaleComponent, {
    [key: string]: any;
}>;
