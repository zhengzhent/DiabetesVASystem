...
export const Gauge = (options) => {
    ...
    return [
        deepMix({}, DEFAULT_OPTIONS, Object.assign({ type: 'interval', transform: [{ type: 'stackY' }], data: totalData, scale: newScale, style: subObject(style, 'arc'), animate: typeof animate === 'object' ? subObject(animate, 'arc') : animate }, resOptions)),
