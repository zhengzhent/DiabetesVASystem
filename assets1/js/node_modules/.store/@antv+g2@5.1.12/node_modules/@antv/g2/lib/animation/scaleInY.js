    ...
    return (from, _, defaults) => {
        ...
        const PolarScaleInY = (shape) => {
            ...
            animation.onframe = function () {
                shape.style.path = createArcPath(Object.assign(Object.assign({}, arcObject), { outerRadius: Number(shape.style.scaleInYRadius) }));
            };
            animation.onfinish = function () {
                shape.style.path = createArcPath(Object.assign(Object.assign({}, arcObject), { outerRadius: outerRadius }));
            };
            return animation;
        };
