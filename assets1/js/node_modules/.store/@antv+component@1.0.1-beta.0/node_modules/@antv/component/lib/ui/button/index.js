...
var Button = /** @class */ (function (_super) {
    ...
    Button.prototype.render = function (attributes, container) {
        ...
        var _d = tslib_1.__read((0, util_2.parseSeriesAttr)(padding), 4), pt = _d[0], pr = _d[1], pb = _d[2], pl = _d[3];
        var height = this.buttonHeight;
        var markerStyle = this.getStyle('marker');
        var markerSize = this.markerSize;
        var style = tslib_1.__assign(tslib_1.__assign({}, markerStyle), { symbol: markerSymbol, x: pl + markerSize / 2, y: height / 2, size: markerSize });
