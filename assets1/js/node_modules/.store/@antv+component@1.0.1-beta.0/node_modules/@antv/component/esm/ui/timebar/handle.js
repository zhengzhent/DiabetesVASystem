...
var ChartModeHandle = /** @class */ (function (_super) {
    ...
    ChartModeHandle.prototype.renderBackground = function () {
        ...
        select(this)
            ...
            .styles(__assign({ x: -width / 2, y: -height / 2, width: width, height: height }, style));
    };
    ChartModeHandle.prototype.renderIcon = function () {
        ...
        select(this)
            ...
            .styles(__assign({ x1: -diffX, y1: -diffY, x2: -diffX, y2: diffY }, style));
        select(this)
    ...
    ChartModeHandle.prototype.renderBorder = function () {
        ...
        select(this)
            ...
            .styles(__assign({ x1: x, y1: -height / 2, x2: x, y2: +height / 2 }, style));
    };
