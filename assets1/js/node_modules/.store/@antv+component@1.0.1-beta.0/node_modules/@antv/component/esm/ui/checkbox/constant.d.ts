...
export declare const CHECKBOX_RECT_STYLE: {
    default: import("../../shapes/types").OmitConflictStyleProps<import("_@antv_g-lite@1.2.20@@antv/g-lite").RectStyleProps>;
    selected: import("../../shapes/types").OmitConflictStyleProps<import("_@antv_g-lite@1.2.20@@antv/g-lite").RectStyleProps>;
};
