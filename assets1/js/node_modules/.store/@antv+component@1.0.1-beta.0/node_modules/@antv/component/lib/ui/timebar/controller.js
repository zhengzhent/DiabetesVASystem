...
var Controller = /** @class */ (function (_super) {
    ...
    Controller.prototype.renderBackground = function () {
        ...
        this.background.attr(tslib_1.__assign({ width: width, height: height }, backgroundStyle));
    };
    Controller.prototype.renderFunctions = function () {
        var _this = this;
        var _a;
        var _b = this.attributes, functions = _b.functions, iconSize = _b.iconSize, iconSpacing = _b.iconSpacing, width = _b.width, height = _b.height, align = _b.align;
        ...
        components.forEach(function (name, index) {
            ...
            if (Ctor === icons_1.SpeedSelect) {
                ...
                var _b = _this.getBBox(), baseX = _b.x, baseY = _b.y;
                var x = style.x, y = style.y;
                var canvas = (_a = _this.ownerDocument) === null || _a === void 0 ? void 0 : _a.defaultView;
                if (canvas) {
                    _this.speedSelect = new Ctor({ style: tslib_1.__assign(tslib_1.__assign({}, style), { zIndex: 100, x: baseX + x, y: baseY + y }) });
