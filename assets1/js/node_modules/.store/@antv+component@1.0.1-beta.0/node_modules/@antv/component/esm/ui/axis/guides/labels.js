...
export function renderLabels(container, data, attr, animate) {
    ...
    return container
        ...
        return update
            ...
            var animation = transition(this, getLabelPos(datum, data, attr), animate.update);
            this.__bbox__ = datum.bbox;
            ...
            onAnimatesFinished(transitions, function () { return overlapHandler.call(container, attr); });
        });
    }, function (exit) {
