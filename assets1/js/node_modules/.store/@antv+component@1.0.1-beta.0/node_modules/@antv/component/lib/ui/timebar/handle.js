...
var ChartModeHandle = /** @class */ (function (_super) {
    ...
    ChartModeHandle.prototype.renderBackground = function () {
        ...
        (0, util_1.select)(this)
            ...
            .styles(tslib_1.__assign({ x: -width / 2, y: -height / 2, width: width, height: height }, style));
    };
    ChartModeHandle.prototype.renderIcon = function () {
        ...
        (0, util_1.select)(this)
            ...
            .styles(tslib_1.__assign({ x1: -diffX, y1: -diffY, x2: -diffX, y2: diffY }, style));
        (0, util_1.select)(this)
    ...
    ChartModeHandle.prototype.renderBorder = function () {
        var _a = this.attributes, width = _a.width, height = _a.height, type = _a.type;
        ...
        (0, util_1.select)(this)
            ...
            .styles(tslib_1.__assign({ x1: x, y1: -height / 2, x2: x, y2: +height / 2 }, style));
    };
