    ...
    Breadcrumb.prototype.render = function (attributes, container) {
        ...
        var _loop_1 = function (i) {
            ...
            var shape = new tag_1.Tag({
                ...
                style: tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ x: cursorX, y: cursorY }, tagStyle), { text: (0, util_1.isNil)(datum.text) ? datum.id : datum.text }), (0, util_1.pick)(datum, ['marker'])), { 
                    // 强制不需要背景
                    padding: 0 }),
            });
