...
export declare const ifNegative: <T extends string | number | symbol>(x: any, a: T, b?: T | undefined) => T | undefined;
export declare const ifPositive: <T extends string | number | symbol>(x: any, a: T, b?: T | undefined) => T | undefined;
