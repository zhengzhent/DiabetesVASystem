 ...
 */
export type ButtonStyleProps = GroupStyleProps & MixAttrs<Partial<PrefixStyleProps<Omit<TextStyleProps, 'text'>, 'text'>> & Partial<PrefixStyleProps<RectStyleProps, 'button'>> & Partial<PrefixStyleProps<Omit<MarkerStyleProps, 'symbol'>, 'marker'>>> & {
