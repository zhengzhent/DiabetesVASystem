    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const viewInstanceof = (viewContainer) => {
            return Array.from(viewContainer.entries()).map(([view, container]) => {
                ...
                const update = createUpdateView((0, selection_1.select)(container), options, library, context);
                return {
                    view,
                    container,
                    options,
                    setState,
                    update: (from) => __awaiter(this, void 0, void 0, function* () {
...
function createUpdateView(selection, options, library, context) {
    ...
    const updates = interactions
        ...
        .filter(filter)
        .map((d) => d[0]);
    return (newOptions, source) => __awaiter(this, void 0, void 0, function* () {
        const transitions = [];
...
function updateInteraction(name, selection, options, view, library, context) {
    var _a;
    const [useInteraction] = (0, library_1.useLibrary)('interaction', library);
