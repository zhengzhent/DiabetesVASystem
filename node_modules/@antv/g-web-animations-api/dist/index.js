    ...
    if (metadata && metadata.syntax && metadata.int) {
        ...
        if (propertyHandler) {
            ...
            if (gLite.runtime.enableCSSParsing) {
                var computedLeft = gLite.runtime.styleValueRegistry.parseProperty(property, left, target);
                var computedRight = gLite.runtime.styleValueRegistry.parseProperty(property, right, target);
                usedLeft = gLite.runtime.styleValueRegistry.computeProperty(property, computedLeft, target);
                usedRight = gLite.runtime.styleValueRegistry.computeProperty(property, computedRight, target);
            }
            else {
