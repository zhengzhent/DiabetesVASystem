...
function renderTrack(container, attr) {
    ...
    container.maybeAppendByClassName(CLASS_NAMES.track, 'path').styles(__assign({ path: getTrackPath(attr) }, style));
}
function renderSelection(container, attr) {
    ...
    var ribbon = container
        ...
        .styles(__assign({ path: getSelectionPath(attr), fill: fill }, style));
    var clipPath = ribbon
