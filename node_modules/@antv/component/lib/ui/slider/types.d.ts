...
export type SliderStyleProps = GroupStyleProps & PrefixObject<RectStyleProps, 'track'> & 
/**
 * 如果 selectionType 为 invert，则为两端反选的样式
 */
PrefixObject<RectStyleProps, 'selection'> & HandleStyleProps & Partial<PrefixStyleProps<Omit<SparklineStyleProps, 'width' | 'height'>, 'sparkline'>> & {
    /** 动画配置 */
