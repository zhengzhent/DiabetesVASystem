...
var Select = /** @class */ (function (_super) {
    ...
    Select.prototype.renderSelect = function () {
        ...
        this.select.attr(tslib_1.__assign(tslib_1.__assign({ width: width, height: height }, selectStyle), { fill: '#fff', strokeWidth: bordered ? 1 : 0 }));
        ...
        if (showDropdownIcon) {
            (0, util_1.select)(this.select)
                ...
                .style('transform', "translate(".concat(width - iconSize - padding[1] - padding[3], ", ").concat(height / 2, ")"))
                .style('lineWidth', 1)
        ...
        // placeholder
        var finalPlaceholderStyle = tslib_1.__assign({ x: padding[3] }, placeholderStyle);
        (0, util_1.select)(this.select)
        ...
        var finalValueStyle = tslib_1.__assign({ x: padding[3] }, labelStyle);
        (0, util_1.select)(this.select)
            .selectAll('.value')
    ...
    Select.prototype.renderDropdown = function () {
        ...
        this.dropdown.attr(tslib_1.__assign({ y: height + spacing, width: bbox.width + padding[1] + padding[3], height: bbox.height + padding[0] + padding[2] }, dropdownStyle));
        // 默认隐藏
