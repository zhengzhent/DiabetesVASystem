...
var Timebar = /** @class */ (function (_super) {
    ...
    Object.defineProperty(Timebar.prototype, "space", {
        /** 计算空间分配 */
        get: function () {
            var _a = this.attributes, width = _a.width, height = _a.height, type = _a.type, controllerHeight = _a.controllerHeight;
            var availableTimelineHeight = (0, util_1.clamp)(+height - controllerHeight, 0, +height);
            var controllerBBox = new util_2.BBox(0, +height - controllerHeight, +width, controllerHeight);
            // chart 模式下可用
            var axisBBox;
            var axisHeight = 0;
            if (type === 'chart') {
                // axis 默认分配高度为 35
                axisHeight = 35;
                axisBBox = new util_2.BBox(0, availableTimelineHeight - axisHeight, +width, axisHeight);
            }
            else
                axisBBox = new util_2.BBox();
            var timelineHeight = type === 'time' ? 10 : availableTimelineHeight;
            var timelineBBox = new util_2.BBox(0, type === 'time' ? availableTimelineHeight : availableTimelineHeight - timelineHeight, +width, timelineHeight - axisHeight);
    ...
    Timebar.prototype.getChartStyle = function (bbox) {
        ...
        if (type === 'time') {
            return tslib_1.__assign({ handleIconShape: function () { return new handle_1.TimeModeHandle({}); }, selectionFill: '#2e7ff8', selectionFillOpacity: 1, showLabelOnInteraction: true, handleLabelDy: isRange ? -15 : 0, autoFitLabel: isRange, handleSpacing: isRange ? -15 : 0, trackFill: '#edeeef', trackLength: width, trackOpacity: 0.5, trackRadius: height / 2, trackSize: height / 2, type: selectionType, values: this.sliderValues, formatter: function (value) {
                ...
                }, x: x, y: y, zIndex: 1 }, userDefinedChartStyle);
        }
        // type === 'chart'
        ...
        return tslib_1.__assign({ handleIconOffset: handleIconOffset, handleIconShape: this.chartHandleIconShape, selectionFill: '#fff', selectionFillOpacity: 0.5, selectionType: 'invert', sparklineSpacing: 0.1, sparklineColumnLineWidth: 0, sparklineColor: '#d4e5fd', sparklineAreaOpacity: 1, sparklineAreaLineWidth: 0, sparklineData: sparklineData, sparklineType: chartType, sparklineScale: 0.8, trackLength: width, trackSize: height, type: selectionType, values: this.sliderValues, x: x, y: y, zIndex: 1 }, userDefinedChartStyle);
    };
