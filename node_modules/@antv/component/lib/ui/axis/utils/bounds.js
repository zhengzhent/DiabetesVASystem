...
exports.getBBox = exports.getBounds = exports.Bounds = void 0;
...
function getBounds(item, margin) {
    ...
    // get dimensions
    var _a = item.getLocalBounds(), _b = tslib_1.__read(_a.min, 2), x = _b[0], y = _b[1], _c = tslib_1.__read(_a.max, 2), right = _c[0], bottom = _c[1];
