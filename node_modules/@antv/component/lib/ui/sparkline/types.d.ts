...
type LineStyleProps = CallableObject<PrefixObject<Omit<GLineStyleProps, 'x1' | 'x2' | 'y1' | 'y2'>, 'line'>, CallbackParameter<Data>> & CallableObject<PrefixObject<Omit<PathStyleProps, 'path' | 'd'>, 'area'>, CallbackParameter<Data>> & {
    /** 是否光滑 */
    smooth?: boolean;
};
...
export type SparklineStyleProps = GroupStyleProps & LineStyleProps & ColumnStyleProps & {
