        ...
        get: function () {
            ...
            return {
                lines: lines.map(function (line, idx) {
                    return tslib_1.__assign({ stroke: _this.getColor(idx), path: smooth ? (0, path_1.lineToCurvePath)(line) : (0, path_1.lineToLinePath)(line) }, lineStyle);
                }),
                areas: areas.map(function (path, idx) {
                    return tslib_1.__assign({ path: path, fill: _this.getColor(idx) }, areaStyle);
                }),
            };
        },
        enumerable: false,
