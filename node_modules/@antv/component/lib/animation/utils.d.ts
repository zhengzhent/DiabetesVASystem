...
export declare function animate(target: DisplayObject | Component<any>, keyframes: Keyframe[], options: GenericAnimation): import("_@antv_g-lite@1.2.20@@antv/g-lite").IAnimation | null;
/**
 ...
 */
export declare function transitionShape(source: DisplayObject, target: DisplayObject, options: GenericAnimation, after?: 'destroy' | 'hide'): (import("_@antv_g-lite@1.2.20@@antv/g-lite").IAnimation | null)[];
/**
 ...
 */
export declare function transition(target: DisplayObject | Component<any>, state: Record<string, any> | (DisplayObject | Component<any>), options: GenericAnimation): import("_@antv_g-lite@1.2.20@@antv/g-lite").IAnimation | null;
